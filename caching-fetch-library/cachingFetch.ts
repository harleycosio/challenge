...
import type { Data } from '../application/validation';
import axios from 'axios';

// Definition for the return value of the useCachingFetch hook
 ...
 *
 * @returns {Record<string, Data>} - The current cache.
 */
export const getCache = (): Record<string, Data> => {
  return { ...cache };
};
